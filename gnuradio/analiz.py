...
class analiz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "analiz")
        ...
        self.frequency = frequency = 244000000
        ...
        self._frequency_range = Range(240000000, 248000000, samp_rate / 2, 244000000, 200)
...
def main(top_block_cls=analiz, options=None):
