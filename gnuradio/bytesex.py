...
class bytesex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bytesex")
        ...
        self.qtgui_histogram_sink_x_1.set_block_alias("4bits")
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_pack_k_bits_bb_0, 0))
...
def main(top_block_cls=bytesex, options=None):
